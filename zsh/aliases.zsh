...
alias mamp="sudo code ~/Sites/_config"
alias tunel="code ~/.ssh"
...
alias eali="code ~/.dotfiles/zsh/aliases.zsh ~/.dotfiles/git/aliases.zsh"
...
alias rub="rvm use --default ruby-2.4.2@global"
